    ...
    <div class="ml-10 mr-10" style="margin-top:-17px">
          <div class="article_head_photo">
              <div id="article_head_imgliq">
                  <div class="article_head_img imgLiquid_bgSize imgLiquid_ready" style="background-image: url(&quot;img/article/brooke-lark01.jpg&quot;); background-size: cover; background-position: center center; background-repeat: no-repeat;">
    ...
    <div class="article_head_sns mt10">
        <div class="max-width overflow center">
            ...
            <div class="right mt3 mr5">
                <span class="gray"><small>2018-02-01</small></span>
            </div>
        </div>
    </div>
  ...
  <div class="boxview_box" id="auto_box">
      ...
      <div class="mobile_article_index_box2 max-width">
        <div class="boxview_left">
          <div class="boxview_leftimg">
            <img src="img/article/relate1.jpg" width="78" height="78">
          </div>
        </div>
        <div class="boxview_right">
          <div class="mobile_article_index_text" id="boxview_righttext">
            <p class="boxview_title not_auto_br text-line-2">ダイエット成功の秘訣はアプリにあった！成功へ導くダイエットアプリ15選</p>
            <div class="overflow">
              <div class="left">
              ...
              <div class="right boxview_writeuser">
                <ul class="list-inline boxview_info">
                  <li><span class="gray333 text-line-1 writer">スポーツマンシップりな</span></li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <a href="topic-sp.php">
      <div class="mobile_article_index_box2 max-width">
        <div class="boxview_left">
          <div class="boxview_leftimg">
            <img src="img/article/relate2.jpg" width="78" height="78">
          </div>
        </div>
        <div class="boxview_right">
          <div class="mobile_article_index_text" id="boxview_righttext">
            <p class="boxview_title not_auto_br text-line-2">スーパーボールにこんな使い道が！？ウエスト引き締め挟むだけダイエット</p>
            <div class="overflow">
              <div class="left">
              ...
              <div class="right boxview_writeuser">
                <ul class="list-inline boxview_info">
                  <li><span class="gray333 text-line-1 writer">いっこだにこださんこだ</span></li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <a href="topic-sp.php">
      <div class="mobile_article_index_box2 max-width">
        <div class="boxview_left">
          <div class="boxview_leftimg">
            <img src="img/article/relate3.jpg" width="78" height="78">
          </div>
        </div>
        <div class="boxview_right">
          <div class="mobile_article_index_text" id="boxview_righttext">
            <p class="boxview_title not_auto_br text-line-2">さつまいもダイエットの方法と効果って？簡単に便秘解消できたという声多数！</p>
            <div class="overflow">
              <div class="left">
    ...
    <a href="topic-sp.php">
      <div class="mobile_article_index_box2 max-width">
        <div class="boxview_left">
          <div class="boxview_leftimg">
            <img src="img/article/relate4.jpg" width="78" height="78">
          </div>
        </div>
        <div class="boxview_right">
          <div class="mobile_article_index_text" id="boxview_righttext">
            <p class="boxview_title not_auto_br text-line-2">歩くだけでシェイプアップ！お尻がキュッと上がる歩き方とは？</p>
            <div class="overflow">
              <div class="left">
    ...
    <a href="topic-sp.php">
      <div class="mobile_article_index_box2 max-width">
        <div class="boxview_left">
          <div class="boxview_leftimg">
            <img src="img/article/relate5.jpg" width="78" height="78">
          </div>
        </div>
        <div class="boxview_right">
          <div class="mobile_article_index_text" id="boxview_righttext">
            <p class="boxview_title not_auto_br text-line-2">痩せすぎてもダメ！男性が好きな7：10の女性の黄金比体型とは？</p>
            <div class="overflow">
              <div class="left">
    ...
    <a href="topic-sp.php">
      <div class="mobile_article_index_box2 max-width">
        <div class="boxview_left">
          <div class="boxview_leftimg">
            <img src="img/article/relate6.jpg" width="78" height="78">
          </div>
        </div>
        <div class="boxview_right">
          <div class="mobile_article_index_text" id="boxview_righttext">
            <p class="boxview_title not_auto_br text-line-2">干しブドウにこんな効果が！？テレビで話題の干しブドウ酢ダイエット</p>
            <div class="overflow">
              <div class="left">
