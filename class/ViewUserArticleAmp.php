...
.article-link-text-left{
  float: left;
  color:#999;
  font-size: 0.8em;
}
.article-link-text-right{
  float: right;
  color: #999;
  font-size: 0.8em;
}
...
#article-head-area2 .article-writer-img{
  display: inline-block;
  float: left;
}
#article-head-area2 .article-writer-name{
  display: inline-block;
  float: left;
  margin: 0 10px;
  line-height: 34px;
...
#article-head-area2 .article-views{
  color: #666;
  font-size: 0.9em;
  float: right;
  margin: 10px;
}
#article-head-release{
  color: #666;
  font-size: 0.7em;
  text-align: right;
  margin: 3px;
...
.ranking-text-right-title{
  display: table-cell;
  vertical-align: middle;
  padding: 0 10px 0 0;
}
/* text decollate talk parts */
.balloon {
  width: 100%;
  overflow: hidden;
  margin-bottom: -25px;
  ...
  <body>
    <div class="content-wrapper js-main">
      ...
      <div id="article-head-area2">
        ...
        <div class="article-views"><?php echo $article_data['views'] ?> views</div>
      </div>
<!--
...
<?php new ViewUserAmpSubContents(5, $article_data); ?>
    ...
    <!-- header -->
    <div id="header1" class="js-header bg_coral">
      <div class="overflow">
        <div id="header-left">
    ...
    <!-- footer -->
    <div id="footer" class="js-footer bg_coral">
        <ul>
