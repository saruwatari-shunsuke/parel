...
<select name="category">
  ...
  <option value="2"<?php echo $c[2] ?>>Excercise</option>
...
導入文<br>
<textarea name="introduction" rows="6" style="width:1000px" placeholder=""><?php echo $_POST['introduction']; ?></textarea>
<br>
...
まとめ<br>
<textarea name="summary" rows="6" style="width:1000px" placeholder=""><?php echo $_POST['summary']; ?></textarea>
<br>
