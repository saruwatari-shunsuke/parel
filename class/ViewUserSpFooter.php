...
?>
    ...
    <div class="mobile_header js-header bg_coral">
      <div class="overflow">
        ...
        <div class="left" id="mobile_header_center">
          <h1 class="mobile_header_title"><a href="/"><img src="/img/common/logo_5.png" class="titlerogo"></a></h1>
        </div>
    ...
    <div id="mobile_side_down_menu" class="is_browser js-panel" style="display: none;">
      <ul class="left_menu_ul">
        ...
        <li class="excercise"><a href="/?c=2" class="gray666">Exercise<br><span class="font60 gray333">運動</span></a></li>
        ...
        <li class="ranking"><a href="/ranking/" class="gray666">Ranking<br><span class="font60 gray333">人気の記事</span></a></li>
      </ul>
    </div>
